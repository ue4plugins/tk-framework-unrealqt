...
#define SBK_QTDATAVISUALIZATION_QVECTOR_QTDATAVISUALIZATION_QBARDATAITEM_IDX 7 // const QVector<QtDataVisualization::QBarDataItem > *
#define SBK_QTDATAVISUALIZATION_QVECTOR_QTDATAVISUALIZATION_QSCATTERDATAITEM_IDX 8 // const QVector<QtDataVisualization::QScatterDataItem > &
...
#define SBK_QTDATAVISUALIZATION_QLIST_QTDATAVISUALIZATION_QVALUE3DAXISPTR_IDX 13 // QList<QtDataVisualization::QValue3DAxis* >
#define SBK_QTDATAVISUALIZATION_QLIST_QTDATAVISUALIZATION_QSURFACE3DSERIESPTR_IDX 14 // QList<QtDataVisualization::QSurface3DSeries* >
#define SBK_QTDATAVISUALIZATION_QLIST_QTDATAVISUALIZATION_QSCATTER3DSERIESPTR_IDX 15 // QList<QtDataVisualization::QScatter3DSeries* >
#define SBK_QTDATAVISUALIZATION_QLIST_QTDATAVISUALIZATION_QABSTRACT3DAXISPTR_IDX 16 // QList<QtDataVisualization::QAbstract3DAxis* >
#define SBK_QTDATAVISUALIZATION_QLIST_QTDATAVISUALIZATION_QBAR3DSERIESPTR_IDX 17 // QList<QtDataVisualization::QBar3DSeries* >
