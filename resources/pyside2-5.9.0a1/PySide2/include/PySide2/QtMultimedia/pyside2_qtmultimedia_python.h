...
#define SBK_QTMULTIMEDIA_QLIST_QMEDIACONTENT_IDX                     5 // const QList<QMediaContent > &
#define SBK_QTMULTIMEDIA_QLIST_QOBJECTPTR_IDX                        6 // const QList<QObject* > &
#define SBK_QTMULTIMEDIA_QLIST_QNETWORKCONFIGURATION_IDX             7 // const QList<QNetworkConfiguration > &
#define SBK_QTMULTIMEDIA_QLIST_QREAL_IDX                             8 // QList<qreal >
#define SBK_QTMULTIMEDIA_QLIST_QSIZE_IDX                             9 // QList<QSize >
#define SBK_QTMULTIMEDIA_QLIST_QSTRING_IDX                           10 // QList<QString >
#define SBK_QTMULTIMEDIA_QLIST_QAUDIO_ROLE_IDX                       11 // QList<QAudio::Role >
#define SBK_QTMULTIMEDIA_QLIST_QVIDEOFRAME_PIXELFORMAT_IDX           12 // QList<QVideoFrame::PixelFormat >
...
#define SBK_QTMULTIMEDIA_QLIST_QCAMERA_FRAMERATERANGE_IDX            15 // QList<QCamera::FrameRateRange >
#define SBK_QTMULTIMEDIA_QPAIR_INT_INT_IDX                           16 // QPair<int,int >
