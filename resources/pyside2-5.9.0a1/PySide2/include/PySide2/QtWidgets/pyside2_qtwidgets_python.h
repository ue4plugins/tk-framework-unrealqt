...
#define SBK_QTWIDGETS_QVECTOR_INT_IDX                                13 // QVector<int >
#define SBK_QTWIDGETS_QLIST_QABSTRACTANIMATIONPTR_IDX                14 // QList<QAbstractAnimation* >
#define SBK_QTWIDGETS_QLIST_QABSTRACTSTATEPTR_IDX                    15 // const QList<QAbstractState* > &
#define SBK_QTWIDGETS_QLIST_QACTIONPTR_IDX                           16 // QList<QAction* >
#define SBK_QTWIDGETS_QHASH_INT_QBYTEARRAY_IDX                       17 // const QHash<int,QByteArray > &
#define SBK_QTWIDGETS_QMAP_INT_QVARIANT_IDX                          18 // QMap<int,QVariant >
#define SBK_QTWIDGETS_QLIST_QPERSISTENTMODELINDEX_IDX                19 // const QList<QPersistentModelIndex > &
#define SBK_QTWIDGETS_QLIST_QDOCKWIDGETPTR_IDX                       20 // const QList<QDockWidget* > &
#define SBK_QTWIDGETS_QLIST_INT_IDX                                  21 // const QList<int > &
#define SBK_QTWIDGETS_QLIST_QABSTRACTBUTTONPTR_IDX                   22 // QList<QAbstractButton* >
#define SBK_QTWIDGETS_QLIST_QWIZARD_WIZARDBUTTON_IDX                 23 // const QList<QWizard::WizardButton > &
#define SBK_QTWIDGETS_QMAP_QDATE_QTEXTCHARFORMAT_IDX                 24 // QMap<QDate,QTextCharFormat >
#define SBK_QTWIDGETS_QLIST_QWIDGETPTR_IDX                           25 // QList<QWidget* >
#define SBK_QTWIDGETS_QLIST_QMDISUBWINDOWPTR_IDX                     26 // QList<QMdiSubWindow* >
#define SBK_QTWIDGETS_QLIST_QLISTWIDGETITEMPTR_IDX                   27 // QList<QListWidgetItem* >
#define SBK_QTWIDGETS_QLIST_QTABLEWIDGETITEMPTR_IDX                  28 // QList<QTableWidgetItem* >
#define SBK_QTWIDGETS_QLIST_QTABLEWIDGETSELECTIONRANGE_IDX           29 // QList<QTableWidgetSelectionRange >
#define SBK_QTWIDGETS_QLIST_QUNDOSTACKPTR_IDX                        30 // QList<QUndoStack* >
#define SBK_QTWIDGETS_QPAIR_QREAL_QPOINTF_IDX                        31 // QPair<qreal,QPointF >
#define SBK_QTWIDGETS_QLIST_QPAIR_QREAL_QPOINTF_IDX                  32 // QList<QPair< qreal,QPointF > >
#define SBK_QTWIDGETS_QPAIR_QREAL_QREAL_IDX                          33 // QPair<qreal,qreal >
#define SBK_QTWIDGETS_QLIST_QPAIR_QREAL_QREAL_IDX                    34 // QList<QPair< qreal,qreal > >
#define SBK_QTWIDGETS_QLIST_QRECTF_IDX                               35 // const QList<QRectF > &
#define SBK_QTWIDGETS_QLIST_QGRAPHICSVIEWPTR_IDX                     36 // QList<QGraphicsView* >
